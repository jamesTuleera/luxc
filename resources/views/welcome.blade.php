    ...
    <div class="hero-container">
      <div id="heroCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="3000">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active" style="background-image: url({{ asset('home_assets/assets/img/hero-carousel/1.jpg') }})">
            <div class="carousel-container">
              <div class="container">
                <h2 class="animate__animated animate__fadeInDown">LUXURY, LIFESTYLE, HOSPITALITY & WELLNESS</h2>
                <p class="animate__animated animate__fadeInUp">Luxcierge Nigeria embodies the pinnacle of sophisticated concierge services, effortlessly mixing practicality with a touch of luxury tailored to the most discerning travelers.</p>
                <a href="#featured-services" class="btn-get-started scrollto animate__animated animate__fadeInUp">Get Started</a>
              </div>
            </div>
          </div>

          <div class="carousel-item" style="background-image: url({{ asset('home_assets/assets/img/hero-carousel/2.jpg') }})">
            <div class="carousel-container">
              <div class="container">
                <h2 class="animate__animated animate__fadeInDown">LUXURY, LIFESTYLE, HOSPITALITY & WELLNESS</h2>
                <p class="animate__animated animate__fadeInUp">Luxcierge Nigeria embodies the pinnacle of sophisticated concierge services, effortlessly mixing practicality with a touch of luxury tailored to the most discerning travelers.</p>
          ...
          <div class="carousel-item" style="background-image: url({{ asset('home_assets/assets/img/hero-carousel/3.jpg') }})">
            <div class="carousel-container">
              <div class="container">
                <h2 class="animate__animated animate__fadeInDown">LUXURY, LIFESTYLE, HOSPITALITY & WELLNESS</h2>
                <p class="animate__animated animate__fadeInUp">Luxcierge Nigeria embodies the pinnacle of sophisticated concierge services, effortlessly mixing practicality with a touch of luxury tailored to the most discerning travelers.</p>
        ...
        <div class="row about-cols">
          ...
          <div class="row about-cols">
            ...
            <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
              <div class="about-col">
                <div class="img">
              <img src="{{ asset('home_assets/assets/img/pexels-cottonbro-studio-6700125-scaled.jpg') }}" alt="" class="img-fluid">
                  <div class="icon"><i class="bi bi-brightness-high"></i></div>
                </div>
